...
export function Footer() {
  return (
    <footer className="border-t border-border bg-card/30 pt-16 pb-8 px-4 md:px-10 mt-20 relative z-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
        <div className="md:col-span-2">
          ...
          >
            ...
            <span className="font-display font-semibold text-xl tracking-tight">DLSBox</span>
          </div>
        ...
        <div>
          <h4 className="font-display font-medium mb-4">Soluções</h4>
        ...
        <div>
          <h4 className="font-display font-medium mb-4">Empresa</h4>
          <ul className="space-y-3">
