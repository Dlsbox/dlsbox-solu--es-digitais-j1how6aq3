...
function StatItem({
  ...
  return (
    <div
      ref={ref}
      className="flex flex-col items-center justify-center p-6 bg-card/30 rounded-2xl border border-border/50 backdrop-blur-sm"
    >
...
export function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
      <div
        className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[120px] mix-blend-screen opacity-50 transition-transform duration-100 ease-out pointer-events-none"
        style={{
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-10 flex flex-col items-center text-center">
        <Reveal>
          <Badge
            variant="outline"
            className="mb-6 px-4 py-1.5 rounded-full border-primary/30 bg-primary/5 text-primary"
          >
        ...
        <Reveal delay={100}>
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold max-w-5xl leading-[1.1] mb-8">
        ...
        >
          ...
          <Button
            ...
            className="w-full sm:w-auto rounded-full px-8 text-base h-14 bg-background/50 backdrop-blur-sm hover:bg-white/5 border-border/50 transition-all"
          >
            Ver soluções
          </Button>
        </Reveal>
